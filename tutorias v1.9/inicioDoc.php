        ...
        <div class="container">
            ...
            <div class="pageSwitch" id="docentes">
                <section class="tutorias" id="tuto">
                    ...
                    <div class="grid" id="docente">
                        <?php
                            ...
                            $query = mysqli_query($conn, "SELECT tutorias.id_tut AS id, materias.nombre AS Materia FROM tutorias, materias WHERE tutorias.materia = materias.id_mat AND tutorias.docente = " . $_COOKIE['ci']);
                ...
                <section class="hidden" id="mate">
                    <form action="uploadManager.php" method="post">
                        ...
                        <div class="item"> 
                            ...
                            <select id="materia" name="materia" onchange='this.blur()' onmouseleave="this.blur()">
                                <?php
                                    $query = mysqli_query($conn, "SELECT area FROM docentes WHERE ci_doc = " . $_COOKIE['ci']);
                        ...
                        <div class="item">
                            <label for="mod"> Cantidad de días: </label>
                        ...
                        <input type="submit" value="CREAR TUTORÍA">
                    </form>
                </section>
